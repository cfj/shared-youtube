...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils.isStandardBrowserEnv()) {
      var cookies = __webpack_require__(134);
...
var _bling = __webpack_require__(119);

var _getYoutubeVideoId = __webpack_require__(121);

var _eventHtml = __webpack_require__(120);

var _searchResultHtml = __webpack_require__(150);
...
function search(e) {
  ...
  if (e.keyCode === 13) {
    ...
    _axios2.default.get('https://www.googleapis.com/youtube/v3/search?key=AIzaSyCXX4mzTs26adm1hR2qAhIJfHbL4yQ4vTw&part=snippet&q=' + this.value + '&type=video,playlist').then(function (res) {
